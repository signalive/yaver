...
/***/ "./node_modules/event-emitter-extra/dist/commonjs.js":
/*!***********************************************************!*\
  !*** ./node_modules/event-emitter-extra/dist/commonjs.js ***!
  \***********************************************************/
...
var _eventEmitterExtra = _interopRequireDefault(__webpack_require__(/*! event-emitter-extra */ "./node_modules/event-emitter-extra/dist/commonjs.js"));
...
_eventEmitterExtra.default.defaultMaxListeners = Infinity;

var Stores =
/*#__PURE__*/
function (_EventEmitterExtra) {
  _inherits(Stores, _EventEmitterExtra);
  ...
  function Stores() {
    ...
    _this = _possibleConstructorReturn(this, (_ref = Stores.__proto__ || Object.getPrototypeOf(Stores)).call.apply(_ref, [this].concat(args)));

    _defineProperty(_this, "storeBank", {});
  ...
  _createClass(Stores, [{
    ...
    key: "set",
    value: function set(name, nextStore) {
      this.storeBank[name] = nextStore;
    }
  }, {
    key: "update",
    value: function update(name, nextStore) {
      var store = this.get(name);
      ...
      var oldStore = _lodash.default.clone(store);

      (0, _assign.default)(store, nextStore);
      this.emit("update_".concat(name), {
        newStore: store,
        oldStore: oldStore
      });
    }
...
function createStore(to) {
  var initial = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {};
  if (!(0, _isUndefined.default)(stores.get(to))) throw new Error("Store ".concat(to, " was already created"));
...
function useStore(to, condition) {
  var store = stores.get(to);
  if ((0, _isUndefined.default)(store)) throw new Error("Store ".concat(to, " is not defined"));
  ...
  var _useState = (0, _react.useState)(Date.now()),
      ...
      shit = _useState2[0],
      setState = _useState2[1]; //eslint-disable-line


  var set = function set(nextStore) {
    return stores.update(to, nextStore);
  };

  (0, _react.useEffect)(function () {
    var updateListener = function updateListener(_ref2) {
      var oldStore = _ref2.oldStore,
      ...
      if (!(0, _isFunction.default)(condition)) {
        ...
        if (condition(oldStore, newStore)) setState(Date.now());
      }
    };

    stores.on("update_".concat(to), updateListener);
    return function () {
      return stores.removeListener("update_".concat(to), updateListener);
    };
  });
  return [store, set];
}
...
function whenChanged() {
  ...
  return function (oldStore, newStore) {
    return fields.some(function (field) {
      var compiledField = _lodash.default.template(field)(newStore);

      return !(0, _utils.isEquivalent)((0, _get.default)(newStore, compiledField), (0, _get.default)(oldStore, compiledField));
    });
  };
}
